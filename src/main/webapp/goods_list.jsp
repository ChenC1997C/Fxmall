            ...
            <ul class="nav nav-list">
                ...
                <li class="active open">
                    ...
                    <ul class="submenu">
                        ...
                        <li>
                            <a href="http://localhost:8080/fxmall/goods_insert.jsp">
                                <i class="icon-pencil"></i>
                                增加商品
                            </a>
                        </li>
                                        ...
                                        <tbody>
                                            <c:forEach var="goods" items="${goodsList}">
                                                <tr>
                                                    ...
                                                    <td class="left"><a href="http://localhost:8080/cust/goods/list#" onclick="window.location.href='cust/goods/add'">${goods.goodName}</a></td>
                                                    ...
                                                    <td class="left">
                                                        <div class="visible-md visible-lg hidden-sm hidden-xs btn-group" style="align:center">
                                                            <button class="btn btn-xs btn-primary" onclick="window.location.href='cust/goods/add'">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="dataTables_paginate paging_bootstrap sender">
                                                <ul class="pagination">
                                                    ...
                                                    <li><a href="http://localhost:8080/cust/goods/list#" class="active">1</a></li>
